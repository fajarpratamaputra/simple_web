                  ...
                  <div class="col">
                      <div class="card card-small mb-4">
                        <div class="card-header border-bottom">
                          <h6 class="m-0">List Summary</h6>
                          <a href="<?=base_url('dashboard/confirm_action')?>" class="mb-2 btn btn-outline-primary mr-2">Confirm</a>
                        </div>                        
                            ...
                            <tbody>
                              <?php if($this->uri->segment(3)==NULL) {$no=0;} else {$no=$this->uri->segment(3);} ; foreach ($data->result() as $row) { $no++;?>
                                  <tr>
                                      ...
                                      <td>
                                        <a href="<?=base_url('dashboard/deleteSummary/'.$row->id)?>" class="mb-2 btn btn-outline-danger mr-2">Delete</a>
                                      </td>
                                  </tr>
                              <?php } ?>       
                            </tbody>                            
