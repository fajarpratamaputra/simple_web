                  ...
                  <div class="col">
                      <div class="card card-small mb-4">
                        <div class="card-header border-bottom">
                          <h6 class="m-0">List Cart</h6>
                          <a href="<?=base_url('dashboard/editCart_action')?>" class="mb-2 btn btn-outline-primary mr-2">Checkout</a>
                        </div>                        
                            ...
                            <tbody>
                              <?php if($this->uri->segment(3)==NULL) {$no=0;} else {$no=$this->uri->segment(3);} ; foreach ($data->result() as $row) { $no++;?>
                                  <tr>
                                      ...
                                      <td>
                                        <a href="<?=base_url('dashboard/deleteCart/'.$row->cart_id)?>" class="mb-2 btn btn-outline-danger mr-2">Delete</a>
                                      </td>
                                  </tr>
                              <?php } ?>       
                            </tbody>                            
