  ...
  <div class="row">
    <div class="col-lg-12 col-md-12">
      ...
      <div class="card card-small mb-3">
        <div class="card-body">
          <form class="add-new-post" action="<?=base_url('dashboard/editPost_action'); ?>" method="post" enctype="multipart/form-data">
            <div class="form-group">
							<label for="title">Title</label>
							<input class="form-control" type="text" name="title" placeholder="Product name" value="<?=$data->title;?>"/>
            ...
            <div class="form-group">
              ...
              <textarea name="description" id="justHtml" hidden="hidden"><?=$data->description?></textarea>              
            </div>
            <!-- Post Overview -->
            <div class='card card-small mb-3'>
